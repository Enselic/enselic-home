...
(global-set-key (kbd "<f5>")                  'simple-programming-project-debug-binary)
...
(global-set-key (kbd "C-c p")                 'simple-programming-project-edit-current-project-file)
(global-set-key (kbd "C-c l")                 'simple-project-load-project)
(global-set-key (kbd "C-c e")                 'simple-project-create-project)
...
(global-set-key (kbd "C-c j")                 'simple-programming-project-grep-frontend)
(global-set-key (kbd "C-c k")                 'kill-current-buffer)
(global-set-key (kbd "C-c C-<tab>")           'lisp-complete-symbol)
(global-set-key (kbd "C-c q")                 'longlines-mode)
(global-set-key (kbd "C-c v")                 'simple-programming-project-svn-status-current-source-root)
